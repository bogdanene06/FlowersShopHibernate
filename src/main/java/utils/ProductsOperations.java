    ...
    public void productsMenu() {
        ...
        do {
            ...
            if (scanner.hasNextInt()) {
                    ...
                    case 1:
                        ...
                        if (scanner.hasNextInt()) {
                            ...
                            if (x == 1) {
                                ...
                                log.warning("Invalid CHARACTER TYPE on \"Creating product\". You should type a " +
                                            "NUMBER!");
                                scanner.nextLine();
                            }
                        } else {
                            log.warning("Invalid CHARACTER TYPE on \"Creating product\". You should type a NUMBER!");
                        }
                        System.out.println();
                        break;
                    case 2:
                ...
                scanner.next();
                log.warning("Invalid CHARACTER TYPE on choosing product menu options. Type a NUMBER between 1 to 7!");
            }
