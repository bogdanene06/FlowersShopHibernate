    ...
    public void clientsMenu() {
        ...
        do {
            ...
            if (scanner.hasNextInt()) {
                ...
                switch (clientOperations) {
                    case 1:
                        ...
                        if (scanner.hasNextInt()) {
                            ...
                            log.warning("Invalid CHARACTER TYPE on \"Creating client\". You should type a NUMBER!");
                        }
                        System.out.println();
                        break;
                    ...
                    case 3:
                        ...
                        if (!foundClients.isEmpty()) {
                            System.out.println("The client named \"" + clientToBeFound + "\" already exists in the " +
                                               "database.");
                        } else {
                            log.info("The name \"" + clientToBeFound + "\" does NOT exist in the database. You can " +
                                     "create it.");
                        }
                        break;
                ...
                scanner.next();
                log.warning("Invalid CHARACTER TYPE on choosing main menu options. Type a NUMBER between 1 to 8!");
